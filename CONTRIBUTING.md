...
You can report issues [here](https://github.com/ba-st/HighchartsSt/issues/new)
...
Tests are auto-generated for the auto-generated code. These are under the packages `HighchartsStV6-Tests` and `HighstockStV6-Tests`. We warned that there's more than 40K tests so it will take a while to run, and later be shown in the Test Runner.
